...
RealisationsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RealisationsComponent, selectors: [["app-realisations"]], decls: 4, vars: 1, consts: [[1, "row"], ["class", "col-md-4 project-card", 4, "ngFor", "ngForOf"], [1, "col-md-4", "project-card"], ["target", "_blank", 3, "href"], [1, "hover-effect"], [1, "project-content"], [1, "btn", "btn-primary", "mt-4"], ["alt", "", 1, "project-image", 3, "src"], [1, "project-title"]], template: function RealisationsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h2");
